# app/sash/imdb_dataset.py
#
# Adapted near-verbatim from PostersPlus (AGPLv3) imdb_dataset.py — see
# /NOTICE.md. Only the cache-module import path below was changed to match
# PosterBridge's package layout; the download/parse/lookup logic is unchanged.
"""
...
from app.cache import claim_app_state_slot, set_app_state
