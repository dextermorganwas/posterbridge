"""
app/sash/discovery.py

Adapted near-verbatim from PostersPlus (AGPLv3) discovery.py — see
/NOTICE.md. Only the import paths were changed for PosterBridge's package
layout; the curated lists and sash-selection logic are unchanged.
...
from app.config import SASH_PRIORITY as DEFAULT_SASH_PRIORITY  # single source of truth
import app.config as _cfg
from app.sash.festivals import festival_label as resolve_festival_label, match_festival_keyword
